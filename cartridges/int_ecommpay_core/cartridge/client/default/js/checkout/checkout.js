...
const base = require('base/checkout/checkout');
		...
		const members = {
			...
			initialize: function () {
				...
				$(window).on('popstate', function (e) {
					//
					// Back button when event states less than the current state in an ordered
...
base.handleCreditCardNumber = function () {}; // Removes checking card error.
